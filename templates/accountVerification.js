...
exports.AccountVerificationEmailTemplate = (firstName, otp) => `
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
                    ...
                    <table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #ffffff; border-radius: 0.75rem; box-shadow: 0 1px 4px rgba(0, 0, 0, 0.1);">
                        ...
                        <tr>
                            <td align="center" style="padding: 0 2rem;">
                                <h1 style="font-size: 2rem; font-weight: 900; margin: 0 0 0.5rem 0; color: #333333;">Verify Your Account</h1>
                                <p style="margin: 0.5rem 0; color: #777777;">Hi ${firstName}, please enter the code below to continue.</p>
                            </td>
                        </tr>
                        <tr>
                            <td align="center" style="padding: 2rem 2rem 1rem 2rem;">
                                <p style="margin: 0; color: #777777; font-size: 1rem; line-height: 1.6;">
                                    Please use the following One-Time Password (OTP) to complete your verification. This code is required to
                        ...
                        <tr>
                            <td align="center" style="padding: 1.5rem 2rem 0 2rem; border-top: 1px solid #e5e7eb;">
                                <p style="margin: 0 0 0.5rem 0; font-size: 0.9rem; color: #777777;">Didn't request this? You can safely ignore this email.</p>
                                <a href="#" style="color: #2563EB; font-weight: 600; text-decoration: none;">Request a new code</a>
                            </td>
                        </tr>
                        <tr>
                            <td align="center" style="padding: 2rem 2rem 3rem 2rem;">
                                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
                                    ...
                                    <tr>
                                        <td align="center">
                                            <p style="margin: 0.3rem 0; color: #777777; font-size: 0.8rem;">© 2024 SecureCorp. All rights reserved.</p>
